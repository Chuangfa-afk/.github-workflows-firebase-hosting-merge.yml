...
//     public static readonly BACKGROUND_PATH = "./Level1_assets/Control.json";
...
//         this.background = this.addUILayer("ui");
...
//     //     let backBtn = <Button>this.add.uiElement(UIElementType.BUTTON, "UI", {position: new Vec2(size.x+110, size.y+75), text: "Back"});
